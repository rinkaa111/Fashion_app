    ...
    return `<div class="container-fluid d-flex">
                ...
                <div class="col-md">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>B-K1 :</strong> ${args.b_k1()}
...
const method = {
    ...
    a_a1: function(){
        return  parseFloat((1/6 * this.leher.value)) + 0.5 + " CM";
    },
    a1_a2: function(){
    ...
    b1_b2: function(){
        return  parseFloat((1/2 * this.l_punggung.value)) + " CM";
    },
    b_k1: function(){
        return  22 + " CM";  //20,21,22,23
    },
    k_k1: function(){
        return  parseFloat((1/4 * this.badan.value)) -  1 + " CM";
    },
    b_c: function(){
        return  ( this.p_punggung.value) + " CM";
    },
    c_c1: function(){
        return  parseFloat((1/4 * this.pinggang.value)) + 0.5 + " CM";
    },
    // a_a1: function(){
